...
I have included a data dictionary with details on what each variable is below each data set on their respective tabs. A more in depth look at different statistics used for NBA data can be found in [the NBA stats glossary](stats.nba.com/help/glossary).
